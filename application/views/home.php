    ...
    <body data-mobile-nav-style="classic" class="custom-cursor">
        ...
        <div class="wrapper-content">
            ...
            <?php if ($pp_logged_in): ?>
            <section class="pt-0 about-section half-section mobile-student-cart overlap-height position-relative overflow-hidden mb-100">
                <div class="w-729px p-0 m-auto">
                    <div class="card-box-avatar">
                        <div class="avatar-info position-relative">
                            <div class="avatar-img">
                                <img src="<?= htmlspecialchars(isset($user_avatar_url) ? $user_avatar_url : base_url('assets/img/default-avatar.png'), ENT_QUOTES, 'UTF-8') ?>" alt="" class="border-radius-6px" data-no-retina=""
                                    onerror="this.onerror=null;this.src='<?= base_url('assets/img/default-avatar.png') ?>';">
                                <div class="avatar_name">
                                    <h5 class="mb-3"><?= $pp_logged_in && !empty($pp_user->name) ? htmlspecialchars($pp_user->name) : 'Guest' ?></h5>
                                    <?php if ($pp_logged_in): ?>
                                        <span><?= !empty($pp_user->email) ? htmlspecialchars($pp_user->email) : '' ?></span>
                                        <span><a href="<?= base_url('Login/logout') ?>">Logout</a></span>
                                    <?php else: ?>
                                        <span><a href="<?= base_url('Login') ?>">Sign in</a> to see your profile</span>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="avatar-heading-right-box <?= ($pp_logged_in && $pp_premium !== 'approved') ? 'justify-content-start' : '' ?>" style="<?= ($pp_logged_in && $pp_premium !== 'approved') ? 'padding-left: 10px;' : '' ?>">
            ...
            <section class="about-section mobile-home-hero home-sec half-section overlap-height position-relative pb-200">
                <div class="container overlap-gap-section p-0">
                    <div class="row position-relative align-items-center justify-content-center">
                        <div class="col-lg-11">

                            <div class="full-width-img" style="background-image: url('./assets/img/img-about-1.png');">
                                <div class="mobile-space-400">
                                    <h3 class="fw-400 fnt-family text-dark-gray ls-minus-1px fancy-text-style-4 mb-5">turn your
                                        Global
                                        <small class="rotated">></small><small class="italic-text">study</small>
                                        <span>Journey in</span>

                                    </h3>
                                    <h4>
                                        <span class="fix-width fnt-family" style="color: #009C70;">/&nbsp;<span
                                                data-fancy-text='{ "effect": "rubber-band", "direction": "left", "string": ["business", "industry", "enterprise"] }'></span>
                                        </span><span class="fnt-family text-white"><span class="fnt-normal fw-400"
                                                style="color: #009C70;">|</span> a reality.</span>
                                    </h4>
                                </div>
                            </div>

                                <div class="sinup-box d-flex absolute-about-signup w-671px align-items-center">
                                    <div class="w-224px">
                                        <a href="<?= base_url('Googlelogins/googleLogin') ?>" class="btn btn-google mb-0 d-inline-flex align-items-center justify-content-center text-decoration-none">
                                            <img src="<?= base_url('assets/img/google.png') ?>" alt="" />
                                            Sign up with Google
                                        </a>
                                        <span class="d-block text-center mt-1 mb-1 text-black">OR</span>
                                        <div class="form-controls position-relative">
                                            <div class="input-groups">
                                                <input type="email" id="homeHeroSignupEmail" class="form-control" placeholder="name@email.com" autocomplete="email">
                                                <button type="button" class="btn-btn-flot" id="homeHeroSignupBtn">Sign up</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="w-50 text-black">
                                        <h5 class="mb-5 fs-16 fw-500 lh-full">
                                            Join #PGS — whether it’s Medical Pathway, STEM, Master’s, or other programs, we’ve
                                            got your admission roadmap.
                                        </h5>
                                        <p class="fs-14 lh-full mb-0">Admission Counsellors, backed by experience. Trusted by
                                            students since 2006 (formerly <br /> CEG). </p>
                                    </div>
                                </div>
                        </div>
                        <div class="full-width-img-after mobile-none"></div>
                    </div>
                </div>
            </section>
             <?php endif; ?>
                            ...
                            <div class="card card-explore border-color-transparent">
                                ...
                                <h5 class="w-520px m-auto">
                                    ...
                                    <span>
                                        ...
                                        Join <a href="<?= base_url('purplepremiumhome') ?>" onclick="event.stopPropagation();"
                        ...
                        <div class="col-lg-8 col-md-12 explore-section">
                            <div class="card card-explore border-color-transparent">
                                ...
                                <h5 class="w-520px m-auto">
                                    ...
                                    <span>
                                        Going for AIMING for top universities or USMLE, PLAB, AMC, or ?
                                        Join <a href="<?= base_url('home/purplepremium_overview') ?>" onclick="event.stopPropagation();"
                                            class="text-purple">#purplePremium </a> for a complete, guided roadmap with expert support from start to admit.
                            ...
                            <form id="studyJourneyForm" action="<?= site_url('Home/submit_study_journey') ?>" method="post">
                                <div class="card-stps que-step-header">
                                    ...
                                    <div class="step step-1">
                                        ...
                                        <div>
                                            <button type="button" class="btn-next" onclick="goNext()" style="border-radius : 10px">Next</button>
                                        </div>
                                    </div>
                        ...
                        <div class="border-radius-6px overflow-hidden">
                            <div class="gradient-border">
                                <div class="gradient-border-inner">
                                    ...
                                    <!--<button onclick="return window.ppOpenModal();">-->
                                    <!--  <span class="btn-icon">📋</span>-->
                                    <!--  Get My Application Checklist-->
                                    <!--</button>-->
                                    <a href="#" onclick="return window.ppOpenModalset();"
                                        ...
                                        <span>
                                            <span class="btn-double-text ls-minus-05px fs-15" data-text="Request it here">Request it here</span>
                                        </span>
                                    </a>
                                </div>
                            </div>
                ...
                <div
                    ...
                    <div class="mb-10px">
                        <div class="mt-10 mt-10 mobile-px-4">
                            ...
                            <a href="/about" style="padding: 8px 30px;"
        ...
        <?php
        $home_events_list = isset($home_events) ? $home_events : [];
        $home_event_tabs = [
            'study_abroad' => 'study abroad masterclass',
            'online_meet_event' => 'online meet event',
            'new_visit' => 'uni visit @ecr',
        ];
        $home_event_cards = [];
        $home_event_card = null;
        $home_first_event = !empty($home_events_list) ? $home_events_list[0] : null;
        foreach ($home_event_tabs as $tab_class => $category_name) {
            $matched = null;
            foreach ($home_events_list as $home_event_item) {
                if (strtolower(trim($home_event_item->category_name ?? '')) === $category_name) {
                    $matched = clone $home_event_item;
                    break;
                }
            }
            if (!$matched && $home_first_event) {
                $matched = clone $home_first_event;
            }
            if ($matched) {
                $matched->_home_tab_class = $tab_class;
                $home_event_cards[] = $matched;
                if (!$home_event_card) $home_event_card = $matched;
            }
        }
        if (!$home_event_card && $home_first_event) {
            $home_event_card = $home_first_event;
        }
        $home_event_title = $home_event_card && !empty($home_event_card->prod_sub_name) ? $home_event_card->prod_sub_name : 'Online study abroad plan meetup.';
        $home_event_who = $home_event_card && !empty($home_event_card->who_is_it_for) ? array_values(array_filter(array_map('trim', preg_split('/\r\n|\r|\n/', $home_event_card->who_is_it_for)))) : ['Final-year student?', 'Recent grad? Researching for masters?', 'This session’s made for you.'];
        $home_event_topics = $home_event_card && !empty($home_event_card->session_topics) ? array_values(array_filter(array_map('trim', preg_split('/\r\n|\r|\n/', $home_event_card->session_topics)))) : ['Masters in USA UK for graduates', 'How to prepare your finances'];
        $home_event_start_ts = $home_event_card && !empty($home_event_card->s_date) ? strtotime($home_event_card->s_date) : strtotime('2025-12-31 12:00:00');
        $home_event_end_ts = $home_event_card && !empty($home_event_card->e_date) ? strtotime($home_event_card->e_date) : $home_event_start_ts;
        $home_event_img = $home_event_card ? event_image_url($home_event_card->image1 ?? null, base_url('assets/img/tab-img.jpg'), $home_event_card->image2 ?? null) : base_url('assets/img/tab-img.jpg');
        $home_event_link = $home_event_card ? base_url('purpleevents/session/' . (int) $home_event_card->id) : base_url('Simplehome');
        ?>

        <section class="bg-tranquil position-relative mobile-faq-cart-box overflow-hidden">
            <script>
                console.log('Home Events DB data:', <?= json_encode($home_events_list, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?>);
                console.log('Home Rendered Event Cards:', <?= json_encode($home_event_cards, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?>);
                console.log('Home Selected Event Card:', <?= json_encode($home_event_card, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?>);
            </script>
                ...
                <div class="row align-items-center mb-4">
                    ...
                    <div class="col-xl-12 tab-style-03 tab-style-new text-center">
                        ...
                        <ul
                            ...
                            <?php foreach ($home_event_tabs as $tab_class => $tab_label): ?>
                                <li class="nav <?= $tab_class === 'study_abroad' ? 'active' : 'mobile-none' ?>"><a data-filter=".<?= htmlspecialchars($tab_class, ENT_QUOTES, 'UTF-8') ?>" href="#"><?= htmlspecialchars($tab_label, ENT_QUOTES, 'UTF-8') ?></a></li>
                            <?php endforeach; ?>
                        </ul>
                ...
                <div class="row">
                    <div class="col-12 filter-content p-md-0" style="min-height: 900px;">
                        <ul class="portfolio-wrapper grid-loading grid gutter-extra-large mobile-ht-full">
                            ...
                            <?php foreach ($home_event_cards as $home_event_item): ?>
                            <?php
                                $card_title = !empty($home_event_item->prod_sub_name) ? $home_event_item->prod_sub_name : (!empty($home_event_item->product_name) ? $home_event_item->product_name : 'Online study abroad plan meetup.');
                                $card_who = !empty($home_event_item->who_is_it_for) ? array_values(array_filter(array_map('trim', preg_split('/\r\n|\r|\n/', $home_event_item->who_is_it_for)))) : ['Final-year student?', 'Recent grad? Researching for masters?', 'This session’s made for you.'];
                                $card_topics = !empty($home_event_item->session_topics) ? array_values(array_filter(array_map('trim', preg_split('/\r\n|\r|\n/', $home_event_item->session_topics)))) : ['Masters in USA UK for graduates', 'How to prepare your finances'];
                                $card_start_ts = !empty($home_event_item->s_date) ? strtotime($home_event_item->s_date) : strtotime('2025-12-31 12:00:00');
                                $card_end_ts = !empty($home_event_item->e_date) ? strtotime($home_event_item->e_date) : $card_start_ts;
                                $card_img = event_image_url($home_event_item->image1 ?? null, base_url('assets/img/tab-img.jpg'), $home_event_item->image2 ?? null);
                                $card_link = base_url('purpleevents/session/' . (int) $home_event_item->id);
                                $card_tab_class = $home_event_item->_home_tab_class ?? 'study_abroad';
                                $card_accordion_id = 'home-event-accordion-' . preg_replace('/[^a-z0-9_-]/i', '', $card_tab_class) . '-' . (int) $home_event_item->id;
                            ?>
                            <li class="grid-item <?= htmlspecialchars($card_tab_class, ENT_QUOTES, 'UTF-8') ?> transition-inner-all w-100">
                                <div class="row mobile-reverse-row">
                                    <div class="col-lg-6 mobile-p-0 mobile-pt-10">
                                        ...
                                        <div class="accordion accordion-style-02" id="<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>"
                                            data-active-icon="icon-feather-minus"
                                            data-inactive-icon="icon-feather-plus">
                                            <div class="accordion-item active-accordion">
                                                <div class="accordion-header border-bottom border-color-extra-medium-gray">
                                                    <a href="#" data-bs-toggle="collapse"
                                                        data-bs-target="#<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>-01" aria-expanded="true"
                                                        data-bs-parent="#<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>">
                                                ...
                                                <div id="<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>-01" class="accordion-collapse collapse show"
                                                    data-bs-parent="#<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>">
                                            ...
                                            <div class="accordion-item">
                                                <div class="accordion-header border-bottom border-color-extra-medium-gray">
                                                    <a href="#" data-bs-toggle="collapse"
                                                        data-bs-target="#<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>-02" aria-expanded="false"
                                                        data-bs-parent="#<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>">
                                                        <div class="accordion-title mb-0 position-relative text-black">
                                                ...
                                                <div id="<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>-02" class="accordion-collapse collapse"
                                                    data-bs-parent="#<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>">
                                                    <div class="accordion-body last-paragraph-no-margin border-bottom border-color-light-medium-gray">
                                            ...
                                            <div class="accordion-item">
                                                <div class="accordion-header border-bottom border-color-transparent">
                                                    <a href="#" data-bs-toggle="collapse"
                                                        data-bs-target="#<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>-03" aria-expanded="false"
                                                        data-bs-parent="#<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>">
                                                        <div class="accordion-title mb-0 position-relative text-black">
                                                            <i class="feather icon-feather-plus"></i><span
                                                ...
                                                <div id="<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>-03" class="accordion-collapse collapse"
                                                    data-bs-parent="#<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>">
                                            ...
                                            <div class="accordion-item">
                                                <div class="accordion-header border-bottom border-color-transparent">
                                                    <a href="#" data-bs-toggle="collapse"
                                                        data-bs-target="#<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>-04" aria-expanded="false"
                                                        data-bs-parent="#<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>">
                                                        <div class="accordion-title mb-0 position-relative text-black">
                                                            <i class="feather icon-feather-plus"></i><span
                                                ...
                                                <div id="<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>-04" class="accordion-collapse collapse"
                                                    data-bs-parent="#<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>">
                                                    <div class="accordion-body last-paragraph-no-margin border-bottom border-color-transparent">
                                                        <p class="fw-400 fs-14 lh-19">We deliver customized marketing campaign to
                                                            use
                                        ...
                                        <div class="overflow-hidden border-radius-16px w-383px">
                                            <div class="card-box-gradiant border p-4">
                                                <div class="card-box-gradiant-header purple-dot">
                                                    <h5 class="mb-0"><?= htmlspecialchars($card_title) ?></h5>
                                                </div>
                                                <div class="date-box">
                                                    <div>
                                                        <div class="box-date-info">
                                                            <span class="date"><?= date('d', $card_start_ts) ?></span>
                                                            <span class="month"><?= date('M y', $card_start_ts) ?></span>
                                                        </div>
                                                        <p class="mb-0 text-black fw-600 fs-12 lh-16 mt-2"><?= date('g:i a', $card_start_ts) ?></p>
                                                        <p class="mb-0 text-black fw-600 fs-12 lh-16 mt-1"><?= htmlspecialchars($home_event_item->mode ?? '') ?></p>
                                                    </div>
                                                    <div>
                                                        <div class="box-date-info">
                                                            <span class="date"><?= date('d', $card_end_ts) ?></span>
                                                            <span class="month"><?= date('M y', $card_end_ts) ?></span>
                                                        </div>
                                                        <p class="mb-0 text-black fw-600 fs-12 lh-16 mt-2"><?= date('g:i a', $card_end_ts) ?></p>
                                                        <p class="mb-0 text-black fw-600 fs-12 lh-16 mt-1"><?= htmlspecialchars($home_event_item->host ?? '') ?></p>
                                                    </div>
                                                </div>
                                                <div class="btn-content w-50">
                                                    <h5 class="mb-0 text-black fw-400 fs-20">Who’s It For?</h5>
                                                    <p class="mb-0 fs-14 lh-18 text-black"><?= nl2br(htmlspecialchars(implode("\n", $card_who))) ?></p>
                                                </div>
                                                <div class="text-content">
                                                    <h5 class="mb-0 text-black fw-400 fs-20">Topics Covered</h5>
                                                    <?php foreach ($card_topics as $card_topic): ?>
                                                    <h6 class="mb-0 text-black fw-400 fs-15 lh-20 "><?= htmlspecialchars($card_topic) ?></h6>
                                                    <?php endforeach; ?>
                                                </div>
                                                <div class="d-flex justify-content-space">
                                                    <a href="<?= $card_link ?>" class="sop-learn-btn bg-blue-500 mt-4 lh-25">Learn More</a>
                                                </div>
                                                <div class="img-left-absoulute">
                                                    <figure class="position-relative m-0 text-center">
                                                        <img src="<?= htmlspecialchars($card_img) ?>" data-no-retina="" onerror="this.src='<?= base_url('assets/img/tab-img.jpg') ?>'">
                                                    </figure>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <?php endforeach; ?>
                            <?php if (empty($home_event_cards)): ?>
                            <li class="grid-item study_abroad transition-inner-all w-100">
                                <p class="text-center text-black mb-0">No upcoming masterclass events at the moment.</p>
                            </li>
                            <?php endif; ?>
                            <?php if (false): ?>
                                    ...
                                    <div class="col-lg-5 mobile-p-0 offset-lg-1">
                                        <div class="overflow-hidden border-radius-16px w-383px">
                                            <div class="card-box-gradiant border p-4">
                                                <div class="card-box-gradiant-header purple-dot">
                                                    <h5 class="mb-0">
                                                        <?= htmlspecialchars($home_event_title) ?>
                                                    </h5>
                                                </div>
                                                <div class="date-box">
                                                    <div>
                                                        <div class="box-date-info">
                                                            <span class="date"><?= date('d', $home_event_start_ts) ?></span>
                                                            <span class="month"><?= date('M y', $home_event_start_ts) ?></span>
                                                        </div>

                                                        <p class="mb-0 text-black fw-600 fs-12 lh-16 mt-2"><?= date('g:i a', $home_event_start_ts) ?></p>
                                                        <p class="mb-0 text-black fw-600 fs-12 lh-16 mt-1"><?= htmlspecialchars($home_event_card->mode ?? '') ?></p>
                                                    </div>
                                                    <div>
                                                        <div class="box-date-info">
                                                            <span class="date"><?= date('d', $home_event_end_ts) ?></span>
                                                            <span class="month"><?= date('M y', $home_event_end_ts) ?></span>
                                                        </div>
                                                        <p class="mb-0 text-black fw-600 fs-12 lh-16 mt-2"><?= date('g:i a', $home_event_end_ts) ?></p>
                                                        <p class="mb-0 text-black fw-600 fs-12 lh-16 mt-1"><?= htmlspecialchars($home_event_card->host ?? '') ?></p>
                                                ...
                                                <div class="text-content">
                                                    <h5 class="mb-0 text-black fw-400 fs-20">Topics Covered</h5>
                                                    <?php foreach ($home_event_topics as $home_event_topic): ?>
                                                    <h6 class="mb-0 text-black fw-400 fs-15 lh-20 "><?= htmlspecialchars($home_event_topic) ?></h6>
                                                    <?php endforeach; ?>
                                                </div>

                                                <div class="d-flex justify-content-space">
                                                    <a href="<?= $home_event_link ?>" class="sop-learn-btn bg-blue-500 mt-4 lh-25">Learn More</a>
                                                </div>

                                                <div class="img-left-absoulute">
                                                    <figure class="position-relative m-0 text-center">
                                                        <img src="<?= htmlspecialchars($home_event_img) ?>" data-no-retina="" onerror="this.src='<?= base_url('assets/img/tab-img.jpg') ?>'">
                                                    </figure>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-box-gradiant border p-4">
                                                ...
                                                <div class="date-box">
                                                    <div>
                                                        ...
                                                        <p class="mb-0 text-black fw-600 fs-12 lh-16 mt-2">12pm to 2 pm</p>
                                                        <p class="mb-0 text-black fw-600 fs-12 lh-16 mt-1">12pm to 2 pm</p>
                                                    </div>
                                                    <div>
                                                        <div class="box-date-info">
                                                            <span class="date">31</span>
                                                ...
                                                <div class="btn-content w-50">
                                                    ...
                                                    <h5 class="mb-0 text-black fw-400 fs-20">Who’s It For?</h5>
                                                    <p class="mb-0 fs-14 lh-18 text-black">Final-year student? Recent grad? Researching
                                                        for
                                                        masters? <br>
                                                ...
                                                <div class="text-content">
                                                    <h5 class="mb-0 text-black fw-400 fs-20">Topics Covered</h5>
                                                    <h6 class="mb-0 text-black fw-400 fs-15 lh-20 ">Masters in USA UK for graduates</h6>
                                                    <h6 class="mb-0 text-black fw-400 fs-15 lh-20">How to prepare your finances
                                                    </h6>
                                                </div>

                                                <div class="d-flex justify-content-space">
                                                    <a href="/Simplehome" class="sop-learn-btn bg-blue-500 mt-4 lh-25">Learn More</a>
                                                </div>

                                                <div class="img-left-absoulute">
                                                    <figure class="position-relative m-0 text-center">
                                                        <img src="./assets/img/tab-img.jpg" data-no-retina="">
                                                    </figure>
                                                </div>
                                            </div>
                                        </div>
    ...
    <div id="ppPremiumModal" class="premium-modal-overlay" style="display: none;" onclick="if(event.target===this){window.ppCloseModal();}">
        ...
        <style>
            .btn-loader {
                ...
                border-radius: 50%;
                animation: btnLoaderSpin 0.7s linear infinite;
        ...
        <script>
            ...
            // Manual next: validate the current step, then advance
            function goNext() {
                ...
                if (!allSelected) {
                    showStudyJourneyAlert('warning', "Please answer all required questions before continuing.");
                    return;
                }
                goToNextStep();
            }
