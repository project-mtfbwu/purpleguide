...
<body data-mobile-nav-style="classic" class="custom-cursor">
   ...
   <?php $this->load->view('sidebar'); ?>
    ...
    <div class="wrapper-content">
        ...
        <!-- AboutUs -->
        <section class="pt-0 about-section half-section mobile-student-cart overlap-height position-relative overflow-hidden">
          <div class="w-729px p-0 m-auto">
                    ...
                    <div class="card-box-avatar">
                        ...
                        <div class="avatar-heading-right-box <?= ($pp_logged_in && $pp_premium !== 'approved') ? 'justify-content-start' : '' ?>" style="<?= ($pp_logged_in && $pp_premium !== 'approved') ? 'padding-left: 10px;' : '' ?>">
                            ...
                            <?php else: /* none or rejected — same as user_dashboard */ ?>
                                <?php if ($pp_logged_in): ?>
...
Everything stays mapped, organized, and right here in one place.
                    ...
                    <div class="border-radius-6px overflow-hidden">
                        <div class="gradient-border">
                            <div class="gradient-border-inner">
                                ...
                                <a href="#" onclick="return window.applicantPremiumOpen();"
        ...
        <?php
        $premium_events_list = isset($home_events) ? $home_events : [];
        $premium_event_tabs = [
        ...
        $premium_event_cards = [];
        $premium_first_event = !empty($premium_events_list) ? $premium_events_list[0] : null;
        foreach ($premium_event_tabs as $tab_class => $category_name) {
            $matched = null;
            foreach ($premium_events_list as $premium_event_item) {
                if (strtolower(trim($premium_event_item->category_name ?? '')) === $category_name) {
                    $matched = clone $premium_event_item;
                    break;
                }
            }
            if (!$matched && $premium_first_event) {
                $matched = clone $premium_first_event;
            }
            if ($matched) {
                $matched->_premium_tab_class = $tab_class;
                $premium_event_cards[] = $matched;
            }
        }
        ?>
                ...
                <div class="row align-items-center mb-4">
                    ...
                    <div class="col-xl-12 tab-style-03 tab-style-new text-center">
                        ...
                        <ul
                            ...
                            <?php foreach ($premium_event_tabs as $tab_class => $tab_label): ?>
                                <li class="nav <?= $tab_class === 'study_abroad' ? 'active' : '' ?>"><a data-filter=".<?= htmlspecialchars($tab_class, ENT_QUOTES, 'UTF-8') ?>" href="#"><?= htmlspecialchars($tab_label, ENT_QUOTES, 'UTF-8') ?></a></li>
                            <?php endforeach; ?>
                        </ul>
                ...
                <div class="row">
                    <div class="col-12 filter-content p-md-0" style="min-height: 900px;">
                        <ul class="portfolio-wrapper grid-loading grid gutter-extra-large mobile-ht-full">
                            ...
                            <?php foreach ($premium_event_cards as $premium_event_item): ?>
                                <?php
                                $card_title = !empty($premium_event_item->prod_sub_name) ? $premium_event_item->prod_sub_name : (!empty($premium_event_item->product_name) ? $premium_event_item->product_name : 'Online study abroad plan meetup.');
                                $card_who = !empty($premium_event_item->who_is_it_for) ? array_values(array_filter(array_map('trim', preg_split('/\r\n|\r|\n/', $premium_event_item->who_is_it_for)))) : ['Final-year student?', 'Recent grad?', 'Researching for masters?', 'This session’s made for you.'];
                                $card_topics = !empty($premium_event_item->session_topics) ? array_values(array_filter(array_map('trim', preg_split('/\r\n|\r|\n/', $premium_event_item->session_topics)))) : ['Masters in USA UK for graduates', 'How to prepare your finances'];
                                $card_start_ts = !empty($premium_event_item->s_date) ? strtotime($premium_event_item->s_date) : strtotime('2025-12-31 12:00:00');
                                $card_end_ts = !empty($premium_event_item->e_date) ? strtotime($premium_event_item->e_date) : $card_start_ts;
                                $card_img = event_image_url($premium_event_item->image1 ?? null, base_url('assets/img/tab-img.jpg'), $premium_event_item->image2 ?? null);
                                $card_link = base_url('purpleevents/session/' . (int) $premium_event_item->id);
                                $card_tab_class = $premium_event_item->_premium_tab_class ?? 'study_abroad';
                                $card_accordion_id = 'premium-event-accordion-' . preg_replace('/[^a-z0-9_-]/i', '', $card_tab_class) . '-' . (int) $premium_event_item->id;
                                ?>
                                                    ...
                                                    <div id="<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>-01" class="accordion-collapse collapse show"
                                                        ...
                                                        <div class="accordion-body last-paragraph-no-margin border-bottom border-color-light-medium-gray">
                                                            <p class="fw-400 fs-14 lh-19">More sessions coming up for Medical & STEM
                                                                aspirants — reach out to our counsellors.More sessions coming up for Medical &
                                                                STEM aspirants — reach out to our counsellors.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div id="<?= htmlspecialchars($card_accordion_id, ENT_QUOTES, 'UTF-8') ?>-02" class="accordion-collapse collapse"
                                                        ...
                                                        <div class="accordion-body last-paragraph-no-margin border-bottom border-color-light-medium-gray">
                                                            <p class="fw-400 fs-14 lh-19">We deliver customized marketing campaign to
                                                                use your audience to make a positive move.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="accordion-item">
                                                ...
                                                <div class="card-box-gradiant border p-4">
                                                    ...
                                                    <div class="date-box">
                                                        <div>
                                                            ...
                                                            <p class="mb-0 text-black fw-600 fs-12 lh-16 mt-1"><?= htmlspecialchars($premium_event_item->mode ?? '', ENT_QUOTES, 'UTF-8') ?></p>
                                                        </div>
                                                        <div>
                                                            <div class="box-date-info">
                                                    ...
                                                    <div class="img-left-absoulute">
                                                        <figure class="position-relative m-0 text-center">
                                                            <img src="<?= htmlspecialchars($card_img, ENT_QUOTES, 'UTF-8') ?>" data-no-retina="" onerror="this.src='<?= base_url('assets/img/tab-img.jpg') ?>'">
                                                        </figure>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <?php endforeach; ?>
                            <?php if (empty($premium_event_cards)): ?>
                            ...
                            <div class="card-box-gradiant border p-4">
                                ...
                                <div class="d-flex justify-content-space">
                                    <button class="sop-learn-btn bg-blue-500 mt-4">Learn More</button>
                                </div>
     ...
     <script>
        // Study-journey quiz navigation (self-contained for this page).
        (function () {
            ...
            function goBack() {
                if (currentStep === 3) clearStepInputs(2);
                if (currentStep === 4) clearStepInputs(3);
                document.querySelector(`.step-${currentStep}`).classList.add('hidden');
                currentStep--;
                document.querySelector(`.step-${currentStep}`).classList.remove('hidden');
                updateProgress();
            ...
            // Expose the handlers used by the inline onclick attributes.
    ...
    <div id="applicantPremiumModal" class="mobile-applicant pgs-modal premium-modal-overlay" style="display: none;" onclick="if(event.target===this){window.applicatModalCloseModal();}">
        <div class="premium-modal-container purple-modal d-flex">
            <div class="panel-left">
                <button class="close-btn desktop-none" aria-label="Close" onclick="return window.applicatCloseModal();">✕</button>
                <div class="brand-row">
            ...
            <div class="panel-right">
                <button class="close-btn mobile-none" aria-label="Close" onclick="return window.applicatCloseModal();">✕</button>
                <div id="formContent">
                    <div class="field-group">
                        ...
                        <div class="field">
                            <input type="tel" id="phoneInput" placeholder="Phone (Whatsapp number preferred)" autocomplete="tel">
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div class="d-flex gap-3">
                            <button type="button" class="modal-btn-pgs">MS / Masters Abroad</button>
    ...
    <div id="applicantPremiumModal2" class="pgs-modal premium-modal-overlay" style="display: none; background: transparent" onclick="if(event.target===this){window.applicatModalCloseModal2();}">
        <div class="premium-modal-container purple-modal d-flex bg-white pgs-modal-2" style="border-radius: 20px !important">
            <button class="close-btn" aria-label="Close" onclick="return window.applicatCloseModal2();">✕</button>
            <div class="text-center">
            ...
            <div class="w-180px">
                <p class="fs-13 fw-400 mb-5 text-black lh-15">We've sent the #PGS Study Toolkit to your email.</p>
                <p class="fs-13 fw-400 mb-5 text-black lh-15">This covers the basics you actually need.</p>
                <p class="fs-13 fw-400 mb-5 text-black lh-15">We'll send your study toolkit and important updates on WhatsApp (If you shared your WhatsApp number) (No spam. Unsubscribe anytime)</p>
            </div>
            <div>
    ...
    <script>
        window.applicantPremiumOpen = function () {
        ...
        window.applicatModalCloseModal = window.applicatCloseModal;
        ...
        window.applicatModalCloseModal2 = window.applicatCloseModal2;
    </script>
</body>
