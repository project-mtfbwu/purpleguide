...
<html lang="en">
  ...
  <body>
  	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
       <a class="navbar-brand" href="#"><h3>CREATE PRODUCT</h3></a>
    </nav>
...
<div class="container">
    ...
    <form method="post" enctype="multipart/form-data" action="<?= base_url().'index.php/users/create_product' ?>">
  <div class="form-group">
    <label for="text">Product Name</label>
    <input type="text" class="form-control"  name="p_name" aria-describedby="nameHelp">
...
<div class="form-group">
    ...
    <input type="file" class="form-control" id="image" name="image" aria-describedby="nameHelp" required>
