                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <form action="<?= base_url('Course_category/add_course_category_data') ?>" method="POST" enctype="multipart/form-data">
                                                <div class="row" form-group>
                                                    <div class="col-6 form-group">
                                                        <div class="mb-3 row">
                                                            <label for="example-text-input" class="col-md-6 col-form-label">Course Category Name*</label>
                                                            <div class="col-md-6">
                                                                <input class="form-control" placeholder = 'Enter Course Category Name' type="text" id="example-text-input" name="category_name" required>
                                                            </div>
                                                        </div>
                                                    </div>                                              
                                                </div>                                               
