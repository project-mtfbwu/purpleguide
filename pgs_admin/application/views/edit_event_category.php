                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Edit Event Category</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <form action="<?= base_url('Event_category/edit_event_category_data') ?>" method="POST" enctype="multipart/form-data">
                                                <div class="row" form-group>
                                                    <div class="col-6 form-group">
                                                      <div class="mb-3 row">
                                                        <label for="example-text-input" class="col-md-6 col-form-label">Event Category Name</label>
                                                        <div class="col-md-6">
                                                            <input class="form-control" type="text" value="<?php echo  $product->category_name; ?>" id="example-text-input" name="category_name"required>
