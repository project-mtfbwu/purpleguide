                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">View Weekly wall</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb p-0 m-0">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url();?>Dashboard">Dashboard</a></li>
                                            <li class="breadcrumb-item active">View Weekly wall</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        <h4 class="m-t-0 header-title"><b>View Weekly wall</b></h4>
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <h4 class="card-title m-0"></h4>
                                            <a href="<?= base_url('Weekly_wall/add_weekly_wall') ?>" class="btn btn-primary">Add Weekly wall</a>
                                        </div>
                                        ...
                                        <?php if ($row->block_status == 0) { ?>
                                                    <a class="btn btn-primary btn-sm" href="<?= base_url('Weekly_wall/block/' . $row->id); ?>">
                                                        Published
                                                    </a>
                                                <?php } else { ?>
                                                    <a class="btn btn-danger btn-sm" href="<?= base_url('Weekly_wall/block/' . $row->id); ?>">
                                                        Unpublished
                                                    </a>
                                        <?php } ?>
                                                 ...
                                                 <td>
                                                            <a class="btn btn-outline-success btn-sm edit" href="<?= base_url('Weekly_wall/edit_weekly_wall/').$row->id ?>" title="Edit">
                                                ...
                                                <!-- Modal -->
                                                      ...
                                                      <div class="modal-dialog">
                                                        <div class="modal-content">
                                                          <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Weekly wall Description</h1>
                                                    ...
                                                    <div class="modal fade" id="title<?php echo $row->id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                      <div class="modal-dialog">
                                                        <div class="modal-content">
                                                          <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Weekly wall Title</h1>                                                            
                                                          </div>
                                                          <div class="modal-body">
...
function confirmDelete(id)
 {
    if (confirm("Are you sure you want to delete this data?")) {
        window.location.href = "<?php echo base_url()?>Weekly_wall/delete_weekly_wall/" + id;
