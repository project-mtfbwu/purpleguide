                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <form action="<?= base_url('Testimonial/add_testimonial_data') ?>" method="POST" enctype="multipart/form-data">
                                                <div class="row" form-group>
                                                    <div class="col-6 form-group">
                                                        <div class="mb-3 row">
                                                        <label for="example-text-input" class="col-md-3 col-form-label">Testimonial  Title*</spam> </label>
                                                        <div class="col-md-9">
                                                            <input class="form-control" placeholder = 'Enter TestimonialEve Title' type="text" id="example-text-input" name="prod_name" required>
                                                        </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6 form-group">
                                                        <div class="mb-3 row">
                                                            <label for="example-text-input" class="col-md-3 col-form-label">Upload Testimonial Image*</label>
                                                            <div class="col-md-9">
