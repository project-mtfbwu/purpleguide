                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body table-responsive">
                                        <h4 class="m-t-0 header-title"><b>View FAQs</b></h4>
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <h4 class="card-title m-0"></h4>
                                            <a href="<?= base_url('Faq/add_faq') ?>" class="btn btn-primary">Add FAQs</a>
                                        </div>
                                        ...
                                        <?php if ($row->block_status == 0) { ?>
                                                    <a class="btn btn-primary btn-sm" href="<?= base_url('Faq/block/' . $row->id); ?>">
                                                        Published
                                                    </a>
                                                <?php } else { ?>
                                                    <a class="btn btn-danger btn-sm" href="<?= base_url('Faq/block/' . $row->id); ?>">
                                                        Unpublished
                                                    </a>
                                        <?php } ?>
                                                 ...
                                                 <td>
                                                            <a class="btn btn-outline-success btn-sm edit" href="<?= base_url('Faq/edit_faq/').$row->id ?>" title="Edit">
                                                ...
                                                <!-- Modal -->
                                                      ...
                                                      <div class="modal-dialog">
                                                        <div class="modal-content">
                                                          <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="exampleModalLabel">FAQs Description</h1>
                                                    ...
                                                    <div class="modal fade" id="title<?php echo $row->id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                      <div class="modal-dialog">
                                                        <div class="modal-content">
                                                          <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="exampleModalLabel">FAQs Title</h1>                                                            
                                                          </div>
                                                          <div class="modal-body">
...
function confirmDelete(id)
 {
    if (confirm("Are you sure you want to delete this data?")) {
        window.location.href = "<?php echo base_url()?>Faq/delete_faq/" + id;
