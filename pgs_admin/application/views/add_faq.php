                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <form action="<?= base_url('Faq/add_faq_data') ?>" method="POST" enctype="multipart/form-data">
                                                <div class="row" form-group>
                                                    <div class="col-6 form-group">
                                                        <div class="mb-3 row">
                                                            <label for="example-text-input" class="col-md-3 col-form-label">FAQs  Title*</spam> </label>
                                                            <div class="col-md-9">
                                                                <input class="form-control" placeholder = 'Enter FAQs Title' type="text" id="example-text-input" name="prod_name" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- <div class="col-6 form-group">
                                                        <div class="mb-3 row">
                                                            <label for="example-text-input" class="col-md-3 col-form-label">Upload Faq Image*</label>
                                                            <div class="col-md-9">
