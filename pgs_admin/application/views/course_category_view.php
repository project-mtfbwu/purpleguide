                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active"> View Course Category</li>
                                        </ol>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <a href="<?= base_url('Course_category/add_course_category') ?>" class="btn btn-primary">Add Course Category</a>
                                        </div>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-primary btn-sm" href="<?= base_url('Course_category/block/' . $row->id); ?>">
                                                        Published
                                                    </a>
                                                    <?php } else { ?>
                                                    <a class="btn btn-danger btn-sm" href="<?= base_url('Course_category/block/' . $row->id); ?>">
                                                        Unpublished
                                                    </a>
                                                    <?php } ?>
                                                </td>
                                                <td>
                                                     <a class="btn btn-outline-success btn-sm edit" href="<?= base_url('Course_category/edit_course_category/').$row->id ?>" title="Edit">
...
function confirmDelete(id)
 {
    if (confirm("Are you sure you want to delete this data?")) {
        window.location.href = "<?php echo base_url()?>Course_category/delete_course_category/" + id;
