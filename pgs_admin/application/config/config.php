...
|
*/
$config['base_url'] = 'https://purpleguide.study/pgs_admin/';
$config['uri_protocol'] = 'REQUEST_URI';
$config['website_base_url'] = getenv('PGS_WEBSITE_BASE_URL') ?: 'https://purpleguide.study';
...
$config['sess_cookie_name'] = 'pgs_admin_session';
